    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                    && Qtils.getContext().getExternalCacheDir() != null) {
                dir = Qtils.getContext().getExternalCacheDir() + File.separator + "log" + File.separator;
            } else {
                dir = Qtils.getContext().getCacheDir() + File.separator + "log" + File.separator;
            }
        }

        public Builder setLogSwitch(boolean logSwitch) {
            LogQtils.sLogSwitch = logSwitch;
            return this;
        }

        public Builder setGlobalTag(String tag) {
            if (!isSpace(tag)) {
                LogQtils.sGlobalTag = tag;
                sTagIsSpace = false;
            } else {
                LogQtils.sGlobalTag = "";
                sTagIsSpace = true;
