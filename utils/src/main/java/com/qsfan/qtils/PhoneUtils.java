...
public final class PhoneUtils {
    ...
    public static boolean isPhone() {
        TelephonyManager tm = (TelephonyManager) Qtils.getContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static String getPhoneStatus() {
        TelephonyManager tm = (TelephonyManager) Qtils.getContext()
    ...
    public static void dial(String phoneNumber) {
        Qtils.getContext().startActivity(IntentUtils.getDialIntent(phoneNumber));
    }
    ...
    public static void call(String phoneNumber) {
        Qtils.getContext().startActivity(IntentUtils.getCallIntent(phoneNumber));
    }
    ...
    public static void sendSms(String phoneNumber, String content) {
        Qtils.getContext().startActivity(IntentUtils.getSendSmsIntent(phoneNumber, content));
    }
    ...
    public static void sendSmsSilent(String phoneNumber, String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(Qtils.getContext(), 0, new Intent(), 0);
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = Qtils.getContext().getContentResolver();
