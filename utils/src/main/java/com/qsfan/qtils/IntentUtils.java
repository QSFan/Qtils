...
public final class IntentUtils {
    ...
    public static Intent getInstallAppIntent(File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            ...
            Uri contentUri = FileProvider.getUriForFile(Qtils.getContext(), "com.your.package.fileProvider", file);
    ...
    public static Intent getLaunchAppIntent(String packageName) {
        return Qtils.getContext().getPackageManager().getLaunchIntentForPackage(packageName);
    }
